...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col justify-center items-center text-center text-white bg-gradient-to-br from-black via-gray-900 to-black pt-20">
      <div className="mb-8">
        <div className="w-32 h-32 mx-auto mb-6 rounded-full bg-gradient-to-br from-green-500 to-blue-600 flex items-center justify-center border-4 border-white/20 shadow-2xl">
          <span className="text-6xl font-bold">DP</span>
        </div>
      </div>
      ...
      <div className="flex gap-4 flex-wrap justify-center">
        ...
        <a 
          ...
          className="px-8 py-4 bg-white/5 text-white rounded-lg hover:bg-white/10 transition border border-white/10 font-semibold"
        >
          GitHub
        </a>
      </div>
