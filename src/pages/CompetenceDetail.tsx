  ...
  return (
    <div className="min-h-screen bg-transparent pt-24 pb-16">
      <div className="max-w-4xl mx-auto p-10 text-white">
        ...
        {/* Header */}
        <div
          className={`bg-gradient-to-br ${categoryColor.bg} rounded-lg p-8 border ${categoryColor.border} mb-8`}
        >
          <div className="flex items-start gap-6 mb-6">
            <i className={`${comp.icon} text-6xl ${categoryColor.text}`}></i>
            <div className="flex-1">
              <h1 className={`text-5xl font-bold mb-2 ${categoryColor.text}`}>
                {comp.nom}
              </h1>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-orange-500/10 rounded-lg p-4 border border-orange-500/20">
              ...
              <p className="opacity-90 text-sm">
                {comp.autocritique.vitesseAcquisition}
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-cyan-500/10 rounded-lg p-4 border border-cyan-500/20">
              <h3 className="font-bold text-cyan-400 mb-3">
                🎯 Lien avec Projet Personnel/Professionnel
              </h3>
